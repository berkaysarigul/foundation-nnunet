...
Next 3 actions:
1. Finish `P1.12` by turning the remaining forbidden-claim list and baseline-comparison rules into an operational methodology contract.
