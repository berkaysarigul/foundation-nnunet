...
3. Treat `P1.9` through `P1.11` as deferred engineering work unless the hybrid is explicitly reopened later.
4. Preserve the repeated-split methodology decisions D-043 through D-045 when future orchestration/reporting code is added.
...
Next 3 actions:
1. Finish `P2.2` by neutralizing stale operational guidance in `CLAUDE.md` and the legacy training notebooks.
