"""Regression tests for the authoritative D-031 ROI-crop config."""
...
class TestAuthoritativePretrainedROICropConfig(unittest.TestCase):
    def test_config_locks_the_fixed_d031_crop_protocol(self) -> None:
        config_path = Path("configs/pretrained_resnet34_roi_crop_authoritative.yaml")
        ...
        self.assertEqual(cfg["data"]["train_crop"]["mode"], "roi_train_only")
        self.assertEqual(cfg["data"]["train_crop"]["crop_size"], 384)
